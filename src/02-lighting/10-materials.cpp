...
int main() {
    ...
    auto window = glfwCreateWindow(WIDTH, HEIGHT, "Lighting - Materials", nullptr, nullptr);
    if (!window) {
    ...
    lighting_shader.attachFromFile("02-lighting/10-materials-lighting.vert")
                   .attachFromFile("02-lighting/10-materials-lighting.frag")
                   .link();
    Shader lamp_shader;
    lamp_shader.attachFromFile("02-lighting/10-materials-lamp.vert")
               .attachFromFile("02-lighting/10-materials-lamp.frag")
               .link();
    ...
    lighting_shader.use();
    lighting_shader.bind(glm::vec3(1.0f, 0.5f, 0.31f), "mat.ka");
    lighting_shader.bind(glm::vec3(1.0f, 0.5f, 0.31f), "mat.kd");
    lighting_shader.bind(glm::vec3(0.5f, 0.5f, 0.5f),  "mat.ks");
    lighting_shader.bind(32.0f, "mat.sp");
    lighting_shader.bind(glm::vec3(1.0f, 1.0f, 1.0f), "light.si");
    lighting_shader.bind(lamp_pos, "light.pos");
    ...
    lighting_shader.bind(glm::vec3(0.2f, 0.2f, 0.2f), "light.ai");
    lighting_shader.bind(glm::vec3(0.5f, 0.5f, 0.5f), "light.di");
