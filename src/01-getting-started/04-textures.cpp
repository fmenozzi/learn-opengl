...
int main() {
    ...
    auto window = glfwCreateWindow(WIDTH, HEIGHT, "Getting Started - Textures", nullptr, nullptr);
    if (!window) {
    ...
    // Shaders
    Shader shader;
    shader.attachFromFile("01-getting-started/04-textures.vert")
          .attachFromFile("01-getting-started/04-textures.frag")
          .link();
